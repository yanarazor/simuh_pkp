...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>Module Builder : Form Builder</h2>
            </div>
...
<br>
    ...
    <div class="admin-box">
        ...
        ?>
            <fieldset id="module_details">
                ...
                <div class="control-group<?php echo form_error('module_name') ? ' error' : ''; ?>">
                    ...
                    <div class="controls">
                        ...
                        <div><a class=" small" role="button" data-toggle="collapse" href="#CollapseModule_Details" aria-expanded="false" aria-controls="CollapseModule_Details">
                        <?php echo lang('mb_form_show_advanced'); ?></a>
                ...
                //--------------------------------------------------------------
                ?>
                <fieldset class="collapse" id="CollapseModule_Details">
                ...
                //--------------------------------------------------------------
                ?>
                <div class="control-group demo-radio-button">
                    <label class='control-label' for='mb_module_db'><?php echo lang('mb_module_db'); ?></label>
                    <div class="controls" id='mb_module_db'>
                        <input name="module_db" id="db_no" type="radio" data-toggle="collapse" data-target="#db_details" checked='checked' aria-expanded="false" value="" <?php echo set_radio('module_db', '', true); ?> class="radio" />
            ...
            //------------------------------------------------------------------
            ?>
            <fieldset class="collapse" id="db_details">
                <legend><?php echo lang('mb_form_table_details'); ?></legend>
                <div class="control-group">
                    <div class="controls">
                        <a class=" small" role="button" data-toggle="collapse" href="#CollapseDB_Details" aria-expanded="false" aria-controls="CollapseDB_Details"><?php echo lang('mb_form_show_advanced'); ?></a>
                    </div>
                </div>
                <?php
                //--------------------------------------------------------------
                ...
                //--------------------------------------------------------------
                ?>
                <fieldset class="collapse" id="CollapseDB_Details">
