...
<div id="login">
	...
	<div class="row-fluid">
		<div class="span12">
			<div align="center" class="alert alert-error alert-dismissible alert-dismissable fade in ">
	...
	<?php echo form_open(LOGIN_URL, array('autocomplete' => 'off')); ?>
		...
		<div class="control-group <?php echo iif( form_error('login') , 'error') ;?>">
			<div class="controls" style="padding:2px;">
		...
		<div class="control-group <?php echo iif( form_error('password') , 'error') ;?>">
			<div class="controls" style="padding:2px;">
				<?=$captcha_image?>&nbsp;<a href="#" onclick="parent.window.location.reload(true)"><i class="fa fa-refresh fa-fw"></i></a>
			</div>
			<div class="controls" style="padding:2px;">
				<input style="width: 95%" type="text" name="captcha_st" id="captcha_st" value="" tabindex="3"/>
			</div>
		</div>
		...
		<div class="control-group">
			<div class="controls" style="padding:2px;" style="align:center;">
				<input class="btn btn-large btn-primary mdl-button mdl-js-button mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast" type="submit" name="log-me-in" id="submit" value="<?php e(lang('us_let_me_in')); ?>" tabindex="5" />
			</div>
		</div>
