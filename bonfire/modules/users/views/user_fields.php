    ...
    <div class="controls">
        ...
        <span class="help-inline"><?php echo form_error('timezones'); ?></span>
            ...
            <div class="control-group <?php echo form_error('eselon') ? 'error' : ''; ?> col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <?php echo form_label(lang('bf_eselon') . lang('bf_form_label_required'), 'eselon', array('class' => 'control-label')); ?>
                <div class='controls'>
                <span class="custom-dropdown small">
                    <select name="eselon" id="eselon" class=" chosen-select-deselect">
                        ...
                        <?php foreach($eseloni as $eselonis):?>
                            <option value="<?php echo $eselonis->kode_eselon?>" <?php if(isset($user->eselon))  echo  ($eselonis->kode_eselon==$user->eselon) ? "selected" : ""; ?>><?php echo $eselonis->nama_eselon; ?></option>
                            <?php endforeach;?>
                        <?php endif;?>
                    </select>
                </span>
