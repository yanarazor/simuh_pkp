    ...
    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        <fieldset>
			...
			<div class="control-group<?php echo form_error('tgl_informasi') ? ' error' : ''; ?>">
                ...
                <div class='controls'>
                    <input id='tgl_informasis' type='text' required='required' name='tgl_informasi'  value="<?php echo set_value('tgl_informasi', isset($informasi->tgl_informasi) ? $informasi->tgl_informasi : ''); ?>" />
            ...
            <div class="control-group<?php echo form_error('isi') ? ' error' : ''; ?>">
                ...
                <div class='controls'>
                    <?php echo form_textarea(array('name' => 'isi', 'id' => 'isi', 'rows' => '5', 'cols' => '80', 'value' => set_value('isi', isset($informasi->isi) ? $informasi->isi : ''))); ?>
                    <span class='help-inline'><?php echo form_error('isi'); ?></span>
                </div>
            </div>
        </fieldset>
        <fieldset class='form-actions'>
            <input type='submit' name='save' class='btn btn-primary' value="<?php echo lang('informasi_action_create'); ?>" />
            <?php echo lang('bf_or'); ?>
