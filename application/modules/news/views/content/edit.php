    ...
    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        <fieldset>
            ...
            <div class="control-group<?php echo form_error('title') ? ' error' : ''; ?> col-lg-9 col-md-9 col-sm-9 col-xs-12">
                ...
                <div class='controls'>
                    <input id='title' class="form-control" type='text' required='required' name='title' maxlength='255' value="<?php echo set_value('title', isset($news->title) ? $news->title : ''); ?>" />
            ...
            <div class="control-group<?php echo form_error('new_date') ? ' error' : ''; ?> col-lg-4 col-md-4 col-sm-4 col-xs-12">
                ...
                <div class='controls'>
                    <input id='new_date' class="form-control"  type='text' name='new_date'  value="<?php echo set_value('new_date', isset($news->new_date) ? $news->new_date : ''); ?>" />
            ...
            <div class="control-group<?php echo form_error('author') ? ' error' : ''; ?> col-lg-4 col-md-4 col-sm-4 col-xs-12">
                ...
                <div class='controls'>
                    <input id='author' class="form-control"  type='text' name='author' maxlength='50' value="<?php echo set_value('author', isset($news->author) ? $news->author : ''); ?>" />
            ...
            <div class="control-group<?php echo form_error('meta_keyword') ? ' error' : ''; ?>col-lg-4 col-md-4 col-sm-4 col-xs-12">
                ...
                <div class='controls'>
                    <input id='meta_keyword' class="form-control"  type='text' name='meta_keyword' maxlength='255' value="<?php echo set_value('meta_keyword', isset($news->meta_keyword) ? $news->meta_keyword : ''); ?>" />
