...
?>
    ...
    <div class="control-group <?php echo form_error('status') ? 'error' : ''; ?> col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <?php echo form_label(lang('informasidatausulan_field_status') . lang('bf_form_label_required'), 'usulan', array('class' => 'control-label')); ?>
                <div class='controls'>
                <span class="custom-dropdown small">
        ...
        <fieldset class='form-actions'>
            <input type='submit' name='save' class='btn btn-primary' value="<?php echo lang('informasidatausulan_action_edit'); ?>" />
            <?php echo lang('bf_or'); ?>
            <?php echo anchor(SITE_AREA . '/content/informasidatausulan', lang('informasidatausulan_cancel'), 'class="btn btn-warning"'); ?>
            
            <?php if ($this->auth->has_permission('Informasidatausulan.Content.Delete')) : ?>
                <?php echo lang('bf_or'); ?>
                <button type='submit' name='delete' formnovalidate class='btn btn-danger' id='delete-me' onclick="return confirm('<?php e(js_escape(lang('informasidatausulan_delete_confirm'))); ?>');">
                    <span class='icon-trash icon-white'></span>&nbsp;<?php echo lang('informasidatausulan_delete_record'); ?>
                </button>
            <?php endif; ?>
        </fieldset>
    <?php echo form_close(); ?>
