...
class Migration_Install_kabupaten_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Kabupaten.Masters.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Kabupaten.Masters.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Kabupaten.Masters.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Kabupaten.Masters.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
