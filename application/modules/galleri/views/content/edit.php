    ...
    <?php echo form_open($this->uri->uri_string(), 'id="frm"'); ?>
        <fieldset>
            ...
            <div class="control-group<?php echo form_error('nama_galleri') ? ' error' : ''; ?>">
                ...
                <div class='controls'>
                    <input id='kode' type='hidden' class="form-control" name='kode' maxlength='200' value="<?php echo set_value('kode', isset($galleri->id) ? $galleri->id : ''); ?>" />
            ...
            <input type='submit' name='save' id="btnsave" class='btn btn-primary' value="Update" />
